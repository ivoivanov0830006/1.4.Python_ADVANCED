...
⦁	On the following lines, you will receive each row with its columns - integers, separated by a 7
single space in the range [-20, 20]
Output
⦁	On the first line, print the maximum sum of the elements in the 3x3 square in the format:
        "Sum = {sum}"
